...
public:
    ...
    /** Gets the weight of the edge between this vertex and the given vertex.
        @return  The edge weight. This value is zero for an unweighted graph
        and is negative if the .edge does not exist */
...
private:
    ...
    std::map<std::string, Edge, std::less<>> adjacencyList;
